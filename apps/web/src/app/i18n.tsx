...
const messages = {
  vi: {
    ...
    "whiteboard.empty": "Lớp học chưa có bảng trắng.",
    "whiteboard.prepare": "Chuẩn bị bảng trắng",
    "whiteboard.preparing": "Đang chuẩn bị…",
    "whiteboard.retry": "Thử lại",
    "whiteboard.error": "Chưa thể tải bảng trắng. Hãy thử lại.",
    "whiteboard.featureOff": "Bảng trắng hiện đang tắt cho môi trường này.",
    "whiteboard.forbidden": "Bạn không có quyền truy cập bảng trắng này.",
    "whiteboard.mutationError":
      "Không thể cập nhật bảng trắng. Hãy tải lại trạng thái rồi thử lại.",
    "whiteboard.open": "Mở và trình bày",
    "whiteboard.suspend": "Tạm dừng",
    "whiteboard.resume": "Tiếp tục",
    "whiteboard.close": "Kết thúc bảng trắng",
    "whiteboard.engineLoading": "Đang tải công cụ vẽ…",
    "whiteboard.engineError": "Không thể kết nối công cụ vẽ.",
    "whiteboard.readOnly": "Chỉ xem",
    "whiteboard.canvasLabel": "Bề mặt bảng trắng tương tác",
    "whiteboard.readSemantic": "Đọc bảng trắng dạng văn bản",
    "whiteboard.menu": "Menu bảng trắng",
    "whiteboard.footerControls": "Điều khiển bảng trắng",
    "whiteboard.semanticTitle": "Nội dung bảng trắng dạng văn bản",
    "whiteboard.semanticDescription":
      "Canvas là bề mặt trực quan. Danh sách có cấu trúc này là phương án đọc thay thế từ cùng dữ liệu bảng trắng.",
    "whiteboard.semanticPage": "Trang",
    "whiteboard.semanticElements": "phần tử",
    "whiteboard.semanticNavigation": "Điều hướng nội dung bảng trắng",
    "whiteboard.semanticPrevious": "Trang trước",
    "whiteboard.semanticNext": "Trang sau",
    "whiteboard.focusCanvas": "Chuyển tiêu điểm tới bảng vẽ",
    "whiteboard.semanticEmpty": "Bảng trắng chưa có nội dung.",
    "whiteboard.untitledElement": "phần tử không có nhãn",
    "whiteboard.status.created": "Đã chuẩn bị",
    "whiteboard.status.open": "Đang trình bày",
    "whiteboard.status.suspended": "Đã tạm dừng",
    "whiteboard.status.closed": "Đã kết thúc",
    "whiteboard.state.created": "Bảng trắng đã sẵn sàng để giáo viên mở.",
    "whiteboard.state.open": "Bảng trắng đang mở.",
    "whiteboard.state.suspended": "Bảng trắng đang tạm dừng.",
    "whiteboard.state.closed": "Bảng trắng đã kết thúc.",
    "whiteboard.connection.connecting": "Đang kết nối bảng trắng…",
    ...
    "capabilities.quotaFiles": "Số tệp tối đa mỗi workspace",
    "capabilities.quotaFileBytes": "Tổng dung lượng tệp (byte)",
    "capabilities.quotaSingleFileBytes": "Dung lượng tối đa mỗi tệp (byte)",
    "capabilities.quotaFileUploadIntents": "Lượt tạo upload intent mỗi giờ",
    "capabilities.quotaActiveMediaSpaces": "Phòng trực tuyến đang hoạt động",
    "capabilities.quotaMediaParticipantsPerSpace":
      "Người tham gia tối đa mỗi phòng",
    ...
    "classFiles.title": "Tệp của lớp",
    "classFiles.description":
      "Tài liệu được giới hạn theo workspace và lớp hiện tại.",
    "classFiles.attachmentOnly": "Chỉ tải xuống an toàn",
    "classFiles.uploadUnavailableTitle": "Tải tệp lên đang tạm tắt",
    "classFiles.uploadUnavailableDescription":
      "TutorHub đang chờ hoàn tất quét an toàn trước khi mở tính năng này cho người dùng.",
    "classFiles.loadingAvailability": "Đang kiểm tra khả năng tải tệp lên...",
    "classFiles.availabilityErrorTitle":
      "Chưa thể xác nhận khả năng tải tệp lên",
    "classFiles.availabilityErrorDescription":
      "Danh sách tệp vẫn an toàn; hãy thử kiểm tra lại trước khi tải tệp mới.",
    "classFiles.chooseFile": "Chọn tệp",
    "classFiles.uploadAction": "Tải tệp lên",
    "classFiles.retryUpload": "Thử tải lại",
    "classFiles.uploading": "Đang tải tệp lên...",
    "classFiles.uploadError":
      "Không thể hoàn tất lượt tải này. Tệp đã chọn vẫn còn để bạn thử lại.",
    "classFiles.uploadedAwaitingProcessing":
      "Tệp đã được chuyển và đang chờ kiểm tra an toàn.",
    "classFiles.clearTransfer": "Xong",
    "classFiles.emptyTitle": "Lớp chưa có tệp",
    "classFiles.emptyDescription":
      "Tệp sẵn sàng và các lượt chuyển bạn được phép quản lý sẽ xuất hiện tại đây.",
    "classFiles.listLabel": "Danh sách tệp của lớp",
    "classFiles.downloadAction": "Tải xuống",
    "classFiles.downloading": "Đang chuẩn bị tải xuống...",
    "classFiles.downloadError":
      "Không thể chuẩn bị lượt tải xuống an toàn. Hãy thử lại.",
    "classFiles.loadMore": "Tải thêm tệp",
    "classFiles.loadingMore": "Đang tải thêm...",
    "classFiles.loading": "Đang tải tệp của lớp...",
    "classFiles.errorTitle": "Không thể tải danh sách tệp",
    "classFiles.errorDescription": "Hãy kiểm tra kết nối và thử lại.",
    "classFiles.forbiddenTitle": "Tệp của lớp không khả dụng",
    "classFiles.forbiddenDescription":
      "Phiên hiện tại không có quyền xem tệp trong lớp này.",
    "classFiles.status.pending": "Chờ tải lên",
    "classFiles.status.uploaded": "Chờ kiểm tra",
    "classFiles.status.processing": "Đang kiểm tra",
    "classFiles.status.ready": "Sẵn sàng",
    "classFiles.status.rejected": "Không được chấp nhận",
    "classFiles.phase.idle": "Chưa bắt đầu",
    "classFiles.phase.checksum": "Đang tính checksum",
    "classFiles.phase.reserving": "Đang giữ chỗ an toàn",
    "classFiles.phase.uploading": "Đang chuyển tệp",
    "classFiles.phase.finalizing": "Đang xác nhận lượt tải",
    "classFiles.phase.complete": "Đã chuyển xong",
    ...
    "classSession.live": "Đang diễn ra",
    "classSession.ended": "Đã kết thúc",
    ...
    "media.launch.start": "Bắt đầu phòng học",
    "media.launch.join": "Vào phòng học",
    "media.launch.opening": "Đang mở phòng học...",
    "media.launch.notReady": "Phòng học chưa được giáo viên mở.",
    "media.launch.error": "Chưa thể mở phòng học. Hãy thử lại.",
    ...
    "media.p405.layoutActiveSpeaker": "Người đang nói",
    "media.p405.layoutPresentation": "Trình bày",
    "media.p405.gridLabel": "Lưới video ổn định",
    "media.p405.stageLabel": "Sân khấu chính",
    "media.p405.railLabel": "Dải người tham gia",
    "media.p405.openParticipants": "Mở danh sách người tham gia",
    "media.p405.close": "Đóng",
    "media.p405.previousPage": "Trang video trước",
    "media.p405.nextPage": "Trang video tiếp theo",
    "media.p405.page": "Trang {page} trên {pages}",
    "media.p405.pagination": "Điều hướng trang video",
    "media.p405.pin": "Ghim {name}",
    "media.p405.unpin": "Bỏ ghim {name}",
    "media.p405.microphoneOn": "Tắt micro",
    "media.p405.microphoneOff": "Bật micro",
    "media.p405.cameraOn": "Tắt camera",
    "media.p405.cameraOff": "Bật camera",
    "media.p405.shareStart": "Chia sẻ màn hình",
    "media.p405.shareStop": "Dừng chia sẻ màn hình",
    "media.p405.devices": "Thiết bị",
    "media.p405.microphoneDevice": "Micro đang dùng",
    "media.p405.cameraDevice": "Camera đang dùng",
    "media.p405.speakerDevice": "Loa đang dùng",
    "media.p405.defaultDevice": "Thiết bị mặc định",
    "media.p405.leave": "Rời phòng",
    "media.p405.leaveTitle": "Rời phòng học?",
    "media.p405.leaveDescription":
      "Camera, micro và chia sẻ màn hình của bạn sẽ dừng ngay.",
    "media.p405.leaveConfirm": "Rời phòng học",
    "media.p405.leaveCancel": "Ở lại",
    "media.p405.noParticipants": "Chưa có video người tham gia để hiển thị.",
    "media.p405.subscribeRestricted":
      "Phiên này không được cấp quyền nhận media từ người tham gia khác.",
    "media.p405.listenOnlyDescription":
      "Bạn đang ở chế độ chỉ nghe; quyền phát camera và micro không được cấp.",
    "media.p405.effectsNone": "Hiệu ứng: Không dùng",
    "media.p405.degradation.reduced-visible-video":
      "Mạng chưa ổn định. TutorHub đang hiển thị ít video hơn nhưng vẫn giữ âm thanh và điều khiển.",
    "media.p405.degradation.lower-remote-quality":
      "Chất lượng video từ xa đã được giảm để ưu tiên âm thanh và điều khiển phòng học.",
    "media.p405.degradation.stage-only-video":
      "Chỉ video chính được tiếp tục. Danh sách người tham gia, âm thanh và điều khiển vẫn hoạt động.",
    "media.p405.degradation.audio-only":
      "Video đang tạm dừng vì kết nối yếu. Âm thanh và điều khiển phòng học vẫn hoạt động.",
    "media.p405.deviceUpdateError":
      "Không thể đổi thiết bị hoặc trạng thái media. Hãy kiểm tra quyền trình duyệt và thử lại.",
    "media.p405.participantVideo": "Video của {name}",
    "media.p405.screenShare": "Màn hình được chia sẻ bởi {name}",
    "media.p405.participantFallback": "Người tham gia",
    "media.p406.loading": "Đang đồng bộ danh sách lớp...",
    "media.p406.refreshing": "Đang làm mới",
    "media.p406.loadError": "Chưa thể đồng bộ danh sách và tín hiệu lớp học.",
    "media.p406.retry": "Thử đồng bộ lại",
    "media.p406.openRoster": "Mở danh sách lớp học",
    "media.p406.rosterTitle": "Danh sách lớp học",
    "media.p406.rosterLabel": "Người tham gia theo thứ tự lớp học",
    "media.p406.rosterEmpty": "Chưa có người tham gia trong danh sách.",
    "media.p406.you": "Bạn",
    "media.p406.raiseHand": "Giơ tay",
    "media.p406.lowerOwnHand": "Hạ tay của bạn",
    "media.p406.raisedHand": "Đã giơ tay.",
    "media.p406.loweredOwnHand": "Đã hạ tay của bạn.",
    "media.p406.ownHandPosition": "Vị trí hàng đợi của bạn: {position}.",
    "media.p406.handQueuePosition": "Tay đang giơ, vị trí {position}",
    "media.p406.lowerNamedHand": "Hạ tay của {name}",
    "media.p406.lowerAllHands": "Hạ tất cả tay",
    "media.p406.loweredHand": "Đã hạ tay người tham gia.",
    "media.p406.loweredAllHands": "Đã hạ tất cả tay.",
    "media.p406.reactions": "Gửi reaction",
    "media.p406.reactionMenu": "Chọn reaction",
    "media.p406.reactionSent": "Đã gửi reaction.",
    "media.p406.reactionAnnouncement":
      "Có {count} reaction đang hiển thị trong lớp học.",
    "media.p406.reaction.thumbs_up": "Thích",
    "media.p406.reaction.clap": "Vỗ tay",
    "media.p406.reaction.heart": "Trái tim",
    "media.p406.reaction.celebrate": "Chúc mừng",
    "media.p406.reaction.laugh": "Cười",
    "media.p406.reaction.surprised": "Ngạc nhiên",
    "media.p406.role.host": "Chủ phòng",
    "media.p406.role.co_host": "Đồng chủ phòng",
    "media.p406.role.teaching_assistant": "Trợ giảng",
    "media.p406.role.attendee": "Người tham gia",
    "media.p406.connection.joining": "Đang vào phòng",
    "media.p406.connection.connected": "Đã kết nối",
    "media.p406.connection.reconnecting": "Đang kết nối lại",
    "media.p406.forbidden": "Quyền tín hiệu lớp học đã thay đổi.",
    "media.p406.conflict":
      "Danh sách lớp học đã thay đổi. Hãy thử lại sau khi đồng bộ.",
    ...
    "home.description":
      "Theo dõi lịch học, trao đổi và tài liệu quan trọng trong workspace hiện tại.",
    "home.search.title": "Tìm trong workspace",
    "home.search.description":
      "Tìm metadata phiên học, cuộc trò chuyện và tệp đã sẵn sàng mà bạn được phép xem.",
    "home.search.label": "Từ khóa tìm kiếm",
    "home.search.placeholder": "Tìm phiên học, cuộc trò chuyện hoặc tệp...",
    "home.search.loading": "Đang tìm...",
    "home.search.error": "Chưa thể tìm kiếm trong workspace này.",
    "home.search.empty": "Không có kết quả phù hợp với “{query}”.",
    "home.search.results": "Kết quả tìm kiếm được phép",
    "home.search.kindConversation": "Tin nhắn",
    "home.search.kindFile": "Tệp",
    "home.search.kindSession": "Phiên học",
    "home.search.directConversation": "Trò chuyện trực tiếp",
    "home.search.classConversation": "Trò chuyện lớp học",
    "home.dashboard.title": "Việc cần chú ý",
    "home.dashboard.description":
      "Mỗi khu vực tải độc lập để một dịch vụ gặp lỗi không làm hỏng toàn bộ trang.",
    "home.viewCalendar": "Xem lịch",
    "home.openMessages": "Mở tin nhắn",
    "home.upcoming.title": "Phiên học sắp tới",
    "home.upcoming.empty": "Không có phiên học nào trong 90 ngày tới.",
    "home.unread.title": "Chưa đọc",
    "home.unread.messages": "Tin nhắn",
    "home.unread.notifications": "Thông báo",
    "home.unread.count": "{count} mục chưa đọc",
    "home.recentFiles.title": "Tệp gần đây",
    "home.recentFiles.empty":
      "Chưa có tệp sẵn sàng trong lớp bạn được phép xem.",
    "home.quickLinks": "Lối tắt workspace",
    "home.loading": "Đang tải",
    "home.retryShort": "Thử lại",
    "home.retryArea": "Thử lại {area}",
    "home.cardError":
      "Khu vực này tạm thời chưa tải được. Các khu vực khác vẫn hoạt động.",
  ...
  en: {
    ...
    "whiteboard.empty": "This classroom does not have a whiteboard yet.",
    "whiteboard.prepare": "Prepare whiteboard",
    "whiteboard.preparing": "Preparing…",
    "whiteboard.retry": "Retry",
    "whiteboard.error": "The whiteboard could not be loaded. Try again.",
    "whiteboard.featureOff":
      "Whiteboard is currently off for this environment.",
    "whiteboard.forbidden": "You do not have access to this whiteboard.",
    "whiteboard.mutationError":
      "The whiteboard could not be updated. Refresh its state and try again.",
    "whiteboard.open": "Open and present",
    "whiteboard.suspend": "Suspend",
    "whiteboard.resume": "Resume",
    "whiteboard.close": "End whiteboard",
    "whiteboard.engineLoading": "Loading drawing tools…",
    "whiteboard.engineError": "The drawing tools could not connect.",
    "whiteboard.readOnly": "View only",
    "whiteboard.canvasLabel": "Interactive whiteboard canvas",
    "whiteboard.readSemantic": "Read whiteboard as text",
    "whiteboard.menu": "Whiteboard menu",
    "whiteboard.footerControls": "Whiteboard controls",
    "whiteboard.semanticTitle": "Whiteboard text representation",
    "whiteboard.semanticDescription":
      "The canvas is the visual surface. This structured list is the reading alternative generated from the same whiteboard data.",
    "whiteboard.semanticPage": "Page",
    "whiteboard.semanticElements": "elements",
    "whiteboard.semanticNavigation": "Whiteboard content navigation",
    "whiteboard.semanticPrevious": "Previous page",
    "whiteboard.semanticNext": "Next page",
    "whiteboard.focusCanvas": "Move focus to drawing canvas",
    "whiteboard.semanticEmpty": "The whiteboard is empty.",
    "whiteboard.untitledElement": "unlabelled element",
    "whiteboard.status.created": "Prepared",
    "whiteboard.status.open": "Presenting",
    "whiteboard.status.suspended": "Suspended",
    "whiteboard.status.closed": "Ended",
    "whiteboard.state.created":
      "The whiteboard is ready for a teacher to open.",
    "whiteboard.state.open": "The whiteboard is open.",
    "whiteboard.state.suspended": "The whiteboard is suspended.",
    "whiteboard.state.closed": "The whiteboard has ended.",
    "whiteboard.connection.connecting": "Connecting to the whiteboard…",
    "whiteboard.connection.connected": "Whiteboard connected.",
    ...
    "capabilities.quotaFiles": "Files per workspace",
    "capabilities.quotaFileBytes": "Total file bytes",
    "capabilities.quotaSingleFileBytes": "Bytes per file",
    "capabilities.quotaFileUploadIntents": "Upload intents per hour",
    "capabilities.quotaActiveMediaSpaces": "Active media spaces",
    "capabilities.quotaMediaParticipantsPerSpace":
    ...
    "classFiles.title": "Class files",
    "classFiles.description":
      "Materials are scoped to the current workspace and class.",
    "classFiles.attachmentOnly": "Safe downloads only",
    "classFiles.uploadUnavailableTitle": "File uploads are temporarily off",
    "classFiles.uploadUnavailableDescription":
      "TutorHub is waiting for the safety-processing gate before enabling uploads for end users.",
    "classFiles.loadingAvailability": "Checking upload availability...",
    "classFiles.availabilityErrorTitle": "Upload availability is unknown",
    "classFiles.availabilityErrorDescription":
      "The file list remains safe; retry this check before starting a new upload.",
    "classFiles.chooseFile": "Choose a file",
    "classFiles.uploadAction": "Upload file",
    "classFiles.retryUpload": "Retry upload",
    "classFiles.uploading": "Uploading file...",
    "classFiles.uploadError":
      "This transfer could not finish. The selected file remains available to retry.",
    "classFiles.uploadedAwaitingProcessing":
      "The file was transferred and is waiting for safety checks.",
    "classFiles.clearTransfer": "Done",
    "classFiles.emptyTitle": "No class files yet",
    "classFiles.emptyDescription":
      "Ready files and transfers you are allowed to manage will appear here.",
    "classFiles.listLabel": "Class file list",
    "classFiles.downloadAction": "Download",
    "classFiles.downloading": "Preparing download...",
    "classFiles.downloadError":
      "A safe download could not be prepared. Try again.",
    "classFiles.loadMore": "Load more files",
    "classFiles.loadingMore": "Loading more...",
    "classFiles.loading": "Loading class files...",
    "classFiles.errorTitle": "Class files could not be loaded",
    "classFiles.errorDescription": "Check your connection and try again.",
    "classFiles.forbiddenTitle": "Class files are unavailable",
    "classFiles.forbiddenDescription":
      "The current session cannot view files in this class.",
    "classFiles.status.pending": "Waiting for upload",
    "classFiles.status.uploaded": "Awaiting checks",
    "classFiles.status.processing": "Checking",
    "classFiles.status.ready": "Ready",
    "classFiles.status.rejected": "Not accepted",
    "classFiles.phase.idle": "Not started",
    "classFiles.phase.checksum": "Calculating checksum",
    "classFiles.phase.reserving": "Reserving securely",
    "classFiles.phase.uploading": "Transferring file",
    "classFiles.phase.finalizing": "Confirming transfer",
    "classFiles.phase.complete": "Transfer complete",
    ...
    "classSession.live": "Live",
    "classSession.ended": "Ended",
    ...
    "media.launch.start": "Start classroom",
    "media.launch.join": "Join classroom",
    "media.launch.opening": "Opening classroom...",
    "media.launch.notReady": "The teacher has not opened this room yet.",
    "media.launch.error": "The classroom could not be opened. Try again.",
    ...
    "media.p405.layoutActiveSpeaker": "Active speaker",
    "media.p405.layoutPresentation": "Presentation",
    "media.p405.gridLabel": "Stable video grid",
    "media.p405.stageLabel": "Main stage",
    "media.p405.railLabel": "Participant rail",
    "media.p405.openParticipants": "Open participant list",
    "media.p405.close": "Close",
    "media.p405.previousPage": "Previous video page",
    "media.p405.nextPage": "Next video page",
    "media.p405.page": "Page {page} of {pages}",
    "media.p405.pagination": "Video page navigation",
    "media.p405.pin": "Pin {name}",
    "media.p405.unpin": "Unpin {name}",
    "media.p405.microphoneOn": "Turn microphone off",
    "media.p405.microphoneOff": "Turn microphone on",
    "media.p405.cameraOn": "Turn camera off",
    "media.p405.cameraOff": "Turn camera on",
    "media.p405.shareStart": "Share screen",
    "media.p405.shareStop": "Stop sharing screen",
    "media.p405.devices": "Devices",
    "media.p405.microphoneDevice": "Active microphone",
    "media.p405.cameraDevice": "Active camera",
    "media.p405.speakerDevice": "Active speaker device",
    "media.p405.defaultDevice": "Default device",
    "media.p405.leave": "Leave room",
    "media.p405.leaveTitle": "Leave the classroom?",
    "media.p405.leaveDescription":
      "Your camera, microphone and screen share will stop immediately.",
    "media.p405.leaveConfirm": "Leave classroom",
    "media.p405.leaveCancel": "Stay",
    "media.p405.noParticipants": "There is no participant video to show yet.",
    "media.p405.subscribeRestricted":
      "This session was not granted permission to receive other participants' media.",
    "media.p405.listenOnlyDescription":
      "You are in listen-only mode; camera and microphone publishing was not granted.",
    "media.p405.effectsNone": "Effects: None",
    "media.p405.degradation.reduced-visible-video":
      "The network is unstable. TutorHub is showing fewer videos while keeping audio and room controls available.",
    "media.p405.degradation.lower-remote-quality":
      "Remote video quality was reduced to protect classroom audio and controls.",
    "media.p405.degradation.stage-only-video":
      "Only the main video continues. The participant list, audio and room controls remain available.",
    "media.p405.degradation.audio-only":
      "Video is paused because the connection is weak. Classroom audio and controls remain available.",
    "media.p405.deviceUpdateError":
      "The device or media state could not be changed. Check browser permission and try again.",
    "media.p405.participantVideo": "Video from {name}",
    "media.p405.screenShare": "Screen shared by {name}",
    "media.p405.participantFallback": "Participant",
    "media.p406.loading": "Syncing the classroom roster...",
    "media.p406.refreshing": "Refreshing",
    "media.p406.loadError":
      "The classroom roster and signals could not be synchronized.",
    "media.p406.retry": "Retry synchronization",
    "media.p406.openRoster": "Open classroom roster",
    "media.p406.rosterTitle": "Classroom roster",
    "media.p406.rosterLabel": "Participants in classroom order",
    "media.p406.rosterEmpty": "There are no participants in the roster yet.",
    "media.p406.you": "You",
    "media.p406.raiseHand": "Raise hand",
    "media.p406.lowerOwnHand": "Lower your hand",
    "media.p406.raisedHand": "Your hand is raised.",
    "media.p406.loweredOwnHand": "Your hand is lowered.",
    "media.p406.ownHandPosition": "Your queue position is {position}.",
    "media.p406.handQueuePosition": "Hand raised, position {position}",
    "media.p406.lowerNamedHand": "Lower {name}'s hand",
    "media.p406.lowerAllHands": "Lower all hands",
    "media.p406.loweredHand": "The participant's hand was lowered.",
    "media.p406.loweredAllHands": "All hands were lowered.",
    "media.p406.reactions": "Send a reaction",
    "media.p406.reactionMenu": "Choose a reaction",
    "media.p406.reactionSent": "Reaction sent.",
    "media.p406.reactionAnnouncement":
      "There are {count} reactions visible in the classroom.",
    "media.p406.reaction.thumbs_up": "Thumbs up",
    "media.p406.reaction.clap": "Clap",
    "media.p406.reaction.heart": "Heart",
    "media.p406.reaction.celebrate": "Celebrate",
    "media.p406.reaction.laugh": "Laugh",
    "media.p406.reaction.surprised": "Surprised",
    "media.p406.role.host": "Host",
    "media.p406.role.co_host": "Co-host",
    "media.p406.role.teaching_assistant": "Teaching assistant",
    "media.p406.role.attendee": "Attendee",
    "media.p406.connection.joining": "Joining",
    "media.p406.connection.connected": "Connected",
    "media.p406.connection.reconnecting": "Reconnecting",
    "media.p406.forbidden": "Your classroom signal permissions changed.",
    "media.p406.conflict":
      "The classroom roster changed. Retry after synchronization.",
    ...
    "home.description":
      "Track important learning sessions, conversations and files in the current workspace.",
    "home.search.title": "Search this workspace",
    "home.search.description":
      "Find session, conversation and ready-file metadata that you are allowed to view.",
    "home.search.label": "Search terms",
    "home.search.placeholder": "Find a session, conversation or file...",
    "home.search.loading": "Searching...",
    "home.search.error": "Search is temporarily unavailable in this workspace.",
    "home.search.empty": "No authorized results match “{query}”.",
    "home.search.results": "Authorized search results",
    "home.search.kindConversation": "Message",
    "home.search.kindFile": "File",
    "home.search.kindSession": "Session",
    "home.search.directConversation": "Direct conversation",
    "home.search.classConversation": "Class conversation",
    "home.dashboard.title": "Needs your attention",
    "home.dashboard.description":
      "Each area loads independently, so one service failure does not break the dashboard.",
    "home.viewCalendar": "View calendar",
    "home.openMessages": "Open messages",
    "home.upcoming.title": "Upcoming sessions",
    "home.upcoming.empty": "No sessions are scheduled in the next 90 days.",
    "home.unread.title": "Unread",
    "home.unread.messages": "Messages",
    "home.unread.notifications": "Notifications",
    "home.unread.count": "{count} unread items",
    "home.recentFiles.title": "Recent files",
    "home.recentFiles.empty":
      "No ready files are available in classes you can view.",
    "home.quickLinks": "Workspace shortcuts",
    "home.loading": "Loading",
    "home.retryShort": "Retry",
    "home.retryArea": "Retry {area}",
    "home.cardError":
      "This area could not load. The other dashboard areas remain available.",
