...
const actionKeys: Record<AuditAction, TranslationKey> = {
  ...
  "class.session.create": "audit.action.classSessionCreate",
  "class.session.update": "audit.action.classSessionUpdate",
  "class.session.cancel": "audit.action.classSessionCancel",
  "class.session.audience.replace": "audit.action.classSessionAudienceReplace",
  "class.session.rsvp.respond": "audit.action.classSessionRsvpRespond",
  "availability.poll.create": "audit.action.availabilityPollCreate",
  "availability.poll.update": "audit.action.availabilityPollUpdate",
  "availability.poll.open": "audit.action.availabilityPollOpen",
  "availability.poll.close": "audit.action.availabilityPollClose",
  "availability.poll.reopen": "audit.action.availabilityPollReopen",
  "availability.poll.cancel": "audit.action.availabilityPollCancel",
  "availability.poll.respond": "audit.action.availabilityPollRespond",
  "availability.poll.share": "audit.action.availabilityPollShare",
  "availability.poll.revoke": "audit.action.availabilityPollRevoke",
  "availability.poll.finalize": "audit.action.availabilityPollFinalize",
  "study_meeting.create": "audit.action.studyMeetingCreate",
  "study_meeting.update": "audit.action.studyMeetingUpdate",
  "study_meeting.cancel": "audit.action.studyMeetingCancel",
};
...
const resourceTypeKeys: Readonly<Record<string, TranslationKey>> = {
  ...
  class_session: "audit.resource.classSession",
  availability_poll: "audit.resource.availabilityPoll",
  study_meeting: "audit.resource.studyMeeting",
