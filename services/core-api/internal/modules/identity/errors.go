...
var (
	...
	ErrInvalidMembershipInvitation          = errors.New("membership invitation input is invalid")
	ErrMembershipInvitationConflict         = errors.New("membership invitation conflicts with existing state")
	ErrMembershipInvitationUnavailable      = errors.New("membership invitation is unavailable")
	ErrMembershipInvitationExpired          = errors.New("membership invitation has expired")
	ErrMembershipInvitationIdentityMismatch = errors.New("the authenticated identity does not match the invitation")
