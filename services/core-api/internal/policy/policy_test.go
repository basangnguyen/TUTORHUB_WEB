	...
	tests := []struct {
		...
		},
		{
			...
			want: []Permission{
				...
				PermissionMediaLock, PermissionMediaModerate,
				PermissionChatSend,
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []Permission{
				...
				PermissionMediaPublish, PermissionMediaShareScreen,
				PermissionMediaLock, PermissionMediaModerate, PermissionChatSend,
				PermissionFileView, PermissionFileUpload,
			},
		},
		{
		...
		},
		{
			...
			want: []Permission{
				...
				PermissionMediaPublish, PermissionMediaShareScreen,
				PermissionMediaModerate, PermissionChatSend,
				PermissionFileView,
			},
		},
		{
