...
- Hiện đang thực hiện **Phase 2 - Identity, tenant và class core**; P2-00 đến P2-02
  đã được triển khai và task kế tiếp là P2-03 Membership invitation/accept/revoke.
