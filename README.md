...
- Hiện đang thực hiện **Phase 2 - Identity, tenant và class core**; P2-00 đến P2-03
  đã được triển khai và task kế tiếp là P2-04 Class lifecycle/ownership/archive.
