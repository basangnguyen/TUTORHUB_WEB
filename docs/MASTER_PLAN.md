...
| Trạng thái gần nhất   | P3-01 staging infrastructure xanh, browser acceptance đang VERIFY; P3-CAL-01 IN PROGRESS    |
...
đã hoàn tất implementation/test local, migration/grants/deploy và public probes; đang
`VERIFY` cho browser acceptance Teacher/Student/IDOR trên staging. ADR-0017 chốt civil
time/DST; ADR-0018 chốt
...
7. P3-01 đã hoàn tất implementation/test local, Neon `14 false`, runtime grants, deploy
   và public probes; hoàn tất browser acceptance Teacher/Student/IDOR trên staging để
   chuyển `VERIFY -> DONE`. Không gọi lượt browser thủ công là Playwright staging.
...
ADR-0019 `PROPOSED`, còn P3-01 scheduling/timezone đã migrate/deploy nhưng vẫn
`VERIFY` chờ browser acceptance Teacher/Student/IDOR.
