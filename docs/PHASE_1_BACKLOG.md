...
**Trạng thái 2026-07-15:** hoàn thành và đã merge vào `main` qua PR #4 tại commit `82261c6`.
...
**Trạng thái 2026-07-15:** hoàn thành và đã merge vào `main` qua PR #4 tại commit `82261c6`; `pnpm verify`, runtime smoke và OpenAPI format đều đạt. Tracing hiện là adapter no-op để gắn provider OpenTelemetry sau khi có ADR.
...
**Trạng thái 2026-07-15:** hoàn thành và đã merge vào `main` qua PR #4 tại commit
`82261c6`. Neon đã migrate đến version `5`, `dirty=false`; classroom và identity integration test đều rollback fixture;
...
**Trạng thái 2026-07-15:** hoàn thành và đã merge vào `main` qua PR #4. `pnpm verify` đạt;
Neon integration test xác nhận
...
**Trạng thái 2026-07-15:** hoàn thành và đã merge vào `main` qua PR #4. Không cần migration
mới và không thêm dependency; schema `classes`/outbox từ P1-05 được tái sử dụng. Neon xác nhận migration `5`,
